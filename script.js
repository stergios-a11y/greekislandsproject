...
const VERSION = 'v4.0';
const BUILD_DATE = '2026-07-05';   // Updated by tools/prerender.py on each deploy
...
const ISLANDS_DATA = {
  ...
  "telendos":     { name:"Telendos",         lat:36.995, lng:26.925, beach:2.8, hist:3.0, night:1.5, access:2.5, afford:4.0, car_need:1.0, has_airport:false, total:3.3, area:5,     pop:50,      days:1, island_group:"Dodecanese", drama:false, hiking:true, springs:false, chora:false, sailing:false },
