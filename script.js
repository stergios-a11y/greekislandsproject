...
const VERSION = 'v4.0';
const BUILD_DATE = '2026-05-01';   // Updated by tools/prerender.py on each deploy
...
const ISLANDS_DATA = {
  ...
  "syros":        { name:"Syros",            lat:37.444, lng:24.942, beach:2.8, hist:4.3, night:3.5, access:4.5, afford:3.5, car_need:3.0, has_airport:true, total:3.8, area:84,    pop:21500,   days:3, island_group:"Cyclades", drama:false, hiking:false, springs:false, chora:false, sailing:false },
  ...
  "samothrace":   { name:"Samothrace",       lat:40.466, lng:25.533, beach:3.0, hist:4.1, night:2.5, access:1.8, afford:4.5, car_need:3.0, has_airport:false, total:3.2, area:178,   pop:2859,    days:3, island_group:"Other", drama:true, hiking:true, springs:true, chora:false, sailing:false },
