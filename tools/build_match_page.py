...
def build(lang, names):
    ...
    if is_el:
        ...
        intro = ('Υπάρχουν 88 κατοικημένα νησιά και οι περισσότεροι οδηγοί σού λένε «όλα υπέροχα». Εδώ κάθε νησί έχει ειλικρινή βαθμολογία σε παραλίες, πολιτισμό, νυχτερινή ζωή, πρόσβαση και τιμές — '
        ...
        how = ('<p>Απαντάς σε λίγες γρήγορες ερωτήσεις — τι σημασία έχουν για σένα οι παραλίες, το μπάτζετ, η νυχτερινή ζωή, ο ρυθμός του ταξιδιού — και ο αλγόριθμος συγκρίνει τις απαντήσεις σου με τις βαθμολογίες και των 88 νησιών. '
        ...
        intro = ('There are 88 inhabited islands and most guides call all of them wonderful. Here, every island carries an honest score across beaches, culture, nightlife, access and price — '
