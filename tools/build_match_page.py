...
def build(lang, names):
    ...
    if is_el:
        ...
        how = ('<p>Απαντάς σε λίγες γρήγορες ερωτήσεις — τι σημασία έχουν για σένα οι παραλίες, το μπάτζετ, η νυχτερινή ζωή, ο ρυθμός του ταξιδιού — και ο αλγόριθμος συγκρίνει τις απαντήσεις σου με τις βαθμολογίες και των 83 νησιών. '
