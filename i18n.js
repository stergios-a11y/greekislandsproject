...
const UI_TEXT = {
  ...
  'getting_there.airport': { en: 'Airport', el: 'Αεροδρόμιο' },
  'getting_there.airport_no': { en: 'No airport — ferry only', el: 'Χωρίς αεροδρόμιο — μόνο πλοίο' },
  'getting_there.port': { en: 'Port', el: 'Λιμάνι' },
  'getting_there.ports': { en: 'Ports', el: 'Λιμάνια' },
  'getting_there.from_piraeus': { en: 'From Piraeus', el: 'Από Πειραιά' },
  'getting_there.alt_gateways': { en: 'Other gateways', el: 'Άλλες πύλες' },
