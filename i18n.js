...
const UI_TEXT = {
  ...
  'help.step3.desc': { en: "Not sure where to go? Answer 8 quick questions and we'll match you to your top islands.", el: 'Δεν είσαι σίγουρος; Απάντησε σε 8 γρήγορες ερωτήσεις και θα σου προτείνουμε τα κορυφαία νησιά.' },
