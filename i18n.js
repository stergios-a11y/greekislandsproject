...
const UI_TEXT = {
  ...
  'nav.tripcost': { en: 'Budget', el: 'Κόστος' },
  ...
  'help.step3.desc': { en: "Not sure where to go? Answer 8 quick questions and we'll match you to your top islands.", el: 'Δεν έχεις αποφασίσει; Απάντησε σε 8 γρήγορες ερωτήσεις και θα σου προτείνουμε τα κορυφαία νησιά.' },
  ...
  'fallback.night': { en: ' Among the best nightlife in Greece.', el: ' Από τα καλύτερα νησιά της Ελλάδας για νυχτερινή ζωή.' },
  ...
  'local.festivals_all': { en: 'All {n} festivals & panigiria, with dates →', el: 'Όλα τα {n} πανηγύρια & γιορτές, με ημερομηνίες →' },
  ...
  'common.mindrive': { en: 'min drive', el: 'λεπτά με το αυτοκίνητο' },
  ...
  'detail.spec.facilities': { en: 'Facilities', el: 'Παροχές' },
  ...
  // --- compact beach card (Sep 2026) ---
  'beach.more':        { en: 'More', el: 'Περισσότερα' },
  'beach.less':        { en: 'Less', el: 'Λιγότερα' },
  'beach.facilities':  { en: 'Facilities', el: 'Παροχές' },
  'beach.rating':      { en: 'Our rating', el: 'Η βαθμολογία μας' },
  'beach.tag.boat':    { en: 'Boat only', el: 'Μόνο με βάρκα' },
  'beach.tag.rope':    { en: 'Rope descent', el: 'Κατάβαση με σκοινί' },
  'beach.tag.org':     { en: 'Organised', el: 'Οργανωμένη' },
  'beach.tag.none':    { en: 'No facilities', el: 'Χωρίς παροχές' },
  'beach.boatnote':    { en: 'Tours generally stop sailing at about 6 Bft from any direction, so check the day before.',
                         el: 'Οι εκδρομές συνήθως δεν βγαίνουν πάνω από 6 μποφόρ, από όποια κατεύθυνση κι αν φυσάει — ρώτα την προηγούμενη μέρα.' },
  // {lo} {hi} = spelled-out compass directions, {n} = Beaufort force
  'beach.avoid':       { en: 'Avoid visiting when the wind blows from the {lo} to {hi} at over {n} Bft',
                         el: 'Απόφυγε την επίσκεψη όταν ο άνεμος φυσάει από {lo} έως {hi} με πάνω από {n} μποφόρ' },
  'beach.avoid.tip':   { en: 'Faces {mid}, so wind from the {lo} through {hi} blows straight onto it.',
                         el: 'Βλέπει {mid}, οπότε άνεμος από {lo} έως {hi} τη χτυπάει κατευθείαν.' },
  'beach.live.flat':   { en: '🏊 Flat water now', el: '🏊 Ήρεμα νερά τώρα' },
  'beach.live.chop':   { en: '🌊 Choppy now', el: '🌊 Κύμα τώρα' },
  'beach.live.tip.bad':  { en: 'Wind now: {from}, {n} Bft ({word}), blowing straight onto this beach. {sea}',
                           el: 'Άνεμος τώρα: {from}, {n} μποφόρ ({word}), κατευθείαν πάνω στην παραλία. {sea}' },
  'beach.live.tip.on':   { en: 'Wind now: {from}, {n} Bft ({word}) onto the beach, but under its {thr} Bft limit. {sea}',
                           el: 'Άνεμος τώρα: {from}, {n} μποφόρ ({word}) πάνω στην παραλία, αλλά κάτω από το όριο των {thr} μποφόρ. {sea}' },
  'beach.live.tip.off':  { en: 'Wind now: {from}, {n} Bft. It is not blowing onto this beach, so the water here is flat.',
                           el: 'Άνεμος τώρα: {from}, {n} μποφόρ. Δεν φυσάει πάνω σε αυτή την παραλία, οπότε τα νερά εδώ είναι ήρεμα.' },
  ...
  'beach.key.bft':     { en: '<i class="w1"></i>0–3 Bft calm · <i class="w2"></i>4–5 breezy · <i class="w3"></i>6+ rough',
                         el: '<i class="w1"></i>0–3 Bft ήρεμα · <i class="w2"></i>4–5 φυσάει · <i class="w3"></i>6+ φουρτούνα' },
  // Shown inside each beach's wind row, only once the live arrow is drawn.
  'beach.wind.arrow':  { en: 'Blue arrow = the wind right now', el: 'Μπλε βέλος = ο άνεμος τώρα' },
  ...
  'wtv.tag.avoid':   { en: 'Avoid',   el: 'Απόφυγε' },
  ...
  'planner.disclaimer':  { en: 'Durations and prices are approximate; check operator schedules close to your travel date.', el: 'Οι διάρκειες και οι τιμές είναι ενδεικτικές. Έλεγξε τα δρομολόγια κοντά στην ημερομηνία ταξιδιού.' },
  ...
  'match.intro': { en: "Answer 8 quick questions and we'll match you to your ideal islands.", el: 'Απάντησε σε 8 γρήγορες ερωτήσεις και θα σε ταιριάξουμε με τα ιδανικά νησιά για εσένα.' },
  ...
  'affiliate.note': { en: '<a href="/privacy/#affiliate">Affiliate links — they support this guide and cost you nothing.</a>', el: '<a href="/el/privacy/#affiliate">Affiliate σύνδεσμοι — στηρίζουν αυτόν τον οδηγό χωρίς κόστος για εσένα.</a>' },
  'mission.author.note': { en: 'This matters because it changes the advice. Someone who has been there tells you which beach is unusable in a north wind, which village is shut in May, and which ferry connection exists on the timetable but not in practice. That is the part you cannot get from reviews.', el: 'Αυτό αλλάζει τη συμβουλή. Κάποιος που έχει πάει σου λέει ποια παραλία δεν πατιέται με βοριά, ποιο χωριό είναι κλειστό τον Μάιο, και ποια ακτοπλοϊκή σύνδεση υπάρχει στο χαρτί αλλά όχι στην πράξη. Αυτό δεν το βρίσκεις στις κριτικές.' },
  ...
  'quiz.live.title': { en: 'Front-runners', el: 'Πρώτα στην κατάταξη' },
  'quiz.live.sub0': { en: 'Best overall right now — answer to reshuffle', el: 'Τα κορυφαία συνολικά — απάντησε για να αλλάξει' },
  'quiz.live.sub': { en: 'Updating with every answer', el: 'Ενημερώνεται με κάθε απάντηση' },
  'quiz.live.new': { en: 'new', el: 'νέο' },
...
function interpretFacing(rawFacing, lang, islandGroup) {
  ...
  const FACING_MAP = {
    'north':     { en: 'North-facing — fully exposed to the meltemi (the dominant summer N/NE wind); often choppy June–September',
                   el: 'Βόρειος προσανατολισμός — πλήρως εκτεθειμένη στο μελτέμι (τον κυρίαρχο καλοκαιρινό Β/ΒΑ άνεμο)· συχνά αγριεμένη Ιούνιο–Σεπτέμβριο' },
    ...
    'northeast': { en: 'Northeast-facing — exposed to the meltemi (the dominant summer N/NE wind); often windy on meltemi days',
                   el: 'Βορειοανατολικός προσανατολισμός — εκτεθειμένη στο μελτέμι (τον κυρίαρχο καλοκαιρινό Β/ΒΑ άνεμο)· συχνά αγριεμένη τις μέρες μελτεμιού' },
    ...
    'east':      { en: 'East-facing — mostly sheltered from the meltemi (the summer N/NE wind); can be choppy on the strongest NE days',
                   el: 'Ανατολικός προσανατολισμός — κυρίως προστατευμένη από το μελτέμι (τον καλοκαιρινό Β/ΒΑ άνεμο)· μπορεί να φουρτουνιάσει τις πιο δυνατές ΒΑ μέρες' },
    ...
    'southeast': { en: 'Southeast-facing — sheltered from the meltemi (the summer N/NE wind); calm most days, exposed only to rare southern winds',
                   el: 'Νοτιοανατολικός προσανατολισμός — προστατευμένη από το μελτέμι (τον καλοκαιρινό Β/ΒΑ άνεμο)· ήρεμη τις περισσότερες μέρες, εκτεθειμένη μόνο σε σπάνιους νότιους ανέμους' },
    ...
    'south':     { en: 'South-facing — sheltered from the meltemi (the summer N/NE wind); calm in summer, exposed only to rare southern winds',
                   el: 'Νότιος προσανατολισμός — προστατευμένη από το μελτέμι (τον καλοκαιρινό Β/ΒΑ άνεμο)· ήρεμη το καλοκαίρι, εκτεθειμένη μόνο σε σπάνιους νότιους ανέμους' },
    ...
    'southwest': { en: 'Southwest-facing — sheltered from the meltemi (the summer N/NE wind); calm in summer, exposed only to rare S/SW winds',
                   el: 'Νοτιοδυτικός προσανατολισμός — προστατευμένη από το μελτέμι (τον καλοκαιρινό Β/ΒΑ άνεμο)· ήρεμη το καλοκαίρι, εκτεθειμένη μόνο σε σπάνιους Ν/ΝΔ ανέμους' },
    ...
    'west':      { en: 'West-facing — sheltered from the meltemi (the summer N/NE wind); calm most summer days, sometimes choppy on rare westerly winds',
                   el: 'Δυτικός προσανατολισμός — προστατευμένη από το μελτέμι (τον καλοκαιρινό Β/ΒΑ άνεμο)· ήρεμη τις περισσότερες καλοκαιρινές μέρες, μερικές φορές φουρτουνιασμένη σε σπάνιους δυτικούς ανέμους' },
    ...
    'northwest': { en: 'Northwest-facing — exposed to the meltemi (the dominant summer N/NE wind); often windy on meltemi days',
                   el: 'Βορειοδυτικός προσανατολισμός — εκτεθειμένη στο μελτέμι (τον κυρίαρχο καλοκαιρινό Β/ΒΑ άνεμο)· συχνά αγριεμένη τις μέρες μελτεμιού' },
  ...
  const FACING_MAP_IONIAN = {
    'north':     { en: "North-facing — open to the Ionian's afternoon maïstros (NW sea breeze); calmest in the morning",
                   el: 'Βόρειος προσανατολισμός — ανοιχτή στον απογευματινό μαΐστρο (τη ΒΔ θαλάσσια αύρα του Ιονίου)· πιο ήρεμη το πρωί' },
    'northeast': { en: 'Northeast-facing — mostly sheltered from the afternoon maïstros (NW breeze); usually calm',
                   el: 'Βορειοανατολικός προσανατολισμός — κυρίως προστατευμένη από τον απογευματινό μαΐστρο (ΒΔ αύρα)· συνήθως ήρεμη' },
    'east':      { en: "East-facing — sheltered from the Ionian's afternoon maïstros (NW breeze); typically calm all day",
                   el: 'Ανατολικός προσανατολισμός — προστατευμένη από τον απογευματινό μαΐστρο του Ιονίου (ΒΔ αύρα)· κατά κανόνα ήρεμη όλη μέρα' },
    'southeast': { en: 'Southeast-facing — well sheltered; calm in summer, exposed only to rare southerlies',
                   el: 'Νοτιοανατολικός προσανατολισμός — καλά προστατευμένη· ήρεμη το καλοκαίρι, εκτεθειμένη μόνο σε σπάνιους νοτιάδες' },
    'south':     { en: 'South-facing — sheltered from the prevailing NW winds; calm in summer, exposed only to rare southerlies',
                   el: 'Νότιος προσανατολισμός — προστατευμένη από τους επικρατούντες ΒΔ ανέμους· ήρεμη το καλοκαίρι, εκτεθειμένη μόνο σε σπάνιους νοτιάδες' },
    'southwest': { en: 'Southwest-facing — calm mornings; picks up some of the afternoon maïstros (NW breeze) late in the day',
                   el: 'Νοτιοδυτικός προσανατολισμός — ήρεμα πρωινά· πιάνει λίγο τον απογευματινό μαΐστρο (ΒΔ αύρα) αργά τη μέρα' },
    'west':      { en: "West-facing — exposed to the afternoon maïstros (the Ionian's NW summer breeze); glassy mornings, waves by late afternoon",
                   el: 'Δυτικός προσανατολισμός — εκτεθειμένη στον απογευματινό μαΐστρο (τη ΒΔ καλοκαιρινή αύρα του Ιονίου)· λάδι το πρωί, κυματάκι το απόγευμα' },
    'northwest': { en: 'Northwest-facing — head-on to the afternoon maïstros (NW breeze); best swum in the morning',
                   el: 'Βορειοδυτικός προσανατολισμός — κόντρα στον απογευματινό μαΐστρο (ΒΔ αύρα)· καλύτερη για μπάνιο το πρωί' },
  };
